...
-(NSURL *)modelURL {
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RestoreSample" withExtension:@"momd"];
    return modelURL;
}
...
-(NSURL *)storeURL {
    return [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BlogFeedback.sqlite"];
}
